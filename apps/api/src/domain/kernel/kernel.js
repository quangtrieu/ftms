...
let TODAY = globalThis.__DB__?.TODAY ?? new Date(2026, 8, 4);          // 04/09/2026, thứ Sáu
let NOW = globalThis.__DB__?.NOW ?? "04/09 09:15";

/* ---------- người dùng ---------- */
const U = globalThis.__DB__?.U ?? {
...
const BAC_DUYET = globalThis.__DB__?.BAC_DUYET ?? [
...
let SEQ = globalThis.__DB__?.SEQ ?? 100;
let T = globalThis.__DB__?.T ?? [
...
/* ---------- thư viện mẫu ---------- */
let MSEQ = globalThis.__DB__?.MSEQ ?? 10;
let MAU = globalThis.__DB__?.MAU ?? [
...
const NGHI_LE = globalThis.__DB__?.NGHI_LE ?? [
...
const RUI_RO = globalThis.__DB__?.RUI_RO ?? [
...
const QUYET_DINH = globalThis.__DB__?.QUYET_DINH ?? [
...
const CAP_TAY = globalThis.__DB__?.CAP_TAY ?? {F001:1, F003:1, F002:1, F005:1, F004:2, F006:3, F007:3};
const CHUC_VU = {
...
let DOI_CHIEU = globalThis.__DB__?.DOI_CHIEU ?? [
...
let HANG_GAN = globalThis.__DB__?.HANG_GAN ?? [
...
let AI_DUNG = globalThis.__DB__?.AI_DUNG ?? {};
...
const AI_CH = globalThis.__DB__?.AI_CH ?? {
  bat: true,
...
let KHOI = globalThis.__DB__?.KHOI ?? [
...
/* =====================================================================
   ...
   ===================================================================== */
const TT_RIENG = globalThis.__DB__?.TT_RIENG ?? [
...
const NGUON_DX = globalThis.__DB__?.NGUON_DX ?? [
...
const BANG_CHUNG = globalThis.__DB__?.BANG_CHUNG ?? [
...
const VI_TRI = globalThis.__DB__?.VI_TRI ?? [
...
const QUYEN = globalThis.__DB__?.QUYEN ?? [
...
const VAI_TRO = globalThis.__DB__?.VAI_TRO ?? {
...
let PHAN_CONG = globalThis.__DB__?.PHAN_CONG ?? [
...
const THUAT_NGU = globalThis.__DB__?.THUAT_NGU ?? [
...
let TIN_NGOAI = globalThis.__DB__?.TIN_NGOAI ?? [
...
(function gieoDanhMuc(){ if (globalThis.__DB__?.T) return;
  let n = 0;
